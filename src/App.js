...
import ChiTietTrangCaNhanCty from "./Component/Business/ChiTietTrangCaNhanCty";
  ...
  return (
    <>
      <Switch>
        ...
        <HomeTemplate
          exact
          path="/chitietbaidang/:maBaiDang"
          Component={ChiTietBaiDang}
        />

        <HomeTemplate
          exact
          path="/chitiettrangcanhancty/:maCty"
          Component={ChiTietTrangCaNhanCty}
        />
        ...
        {userLogin.data ? (
          userLogin.data[0].loaiUser[0] === "admin" ? (
            <Switch>
              ...
              <AdminTemplate
                exact
                path="/admin/forbusiness"
                Component={AdminForBusiness}
              />
              <AdminTemplate
                exact
                path="/admin/forpersonal"
                Component={AdminForPersonal}
              />
